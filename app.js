...
window.TRANSLATIONS = {
  ru: {
    ...
    "contacts.role.vitya": "Co-Founder & UI/UX",
    ...
    "contacts.form.select.redesign": "Редизайн сайта",
    "contacts.form.select.ai_integration": "Интеграция AI",
    "contacts.form.select.other": "Другое",
    ...
    "faq.a1": "Стоимость рассчитывается индивидуально. Вы можете использовать наш интерактивный калькулятор для предварительной оценки.",
    ...
    "testimonials.form.company": "Компания",
  ...
  en: {
    ...
    "contacts.form.select.redesign": "Website Redesign",
    "contacts.form.select.ai_integration": "AI Integration",
    ...
    "faq.a1": "The cost is calculated individually. You can use our interactive calculator for a preliminary estimate.",
    ...
    "testimonials.form.company": "Company",
  ...
  ro: {
    ...
    "contacts.form.select.redesign": "Redesign site",
    "contacts.form.select.ai_integration": "Integrare AI",
    "contacts.form.select.other": "Altul",
    ...
    "faq.a1": "Costul se calculează individual. Puteți utiliza calculatorul nostru interactiv pentru o estimare preliminară.",
    ...
    "testimonials.form.company": "Companie",
